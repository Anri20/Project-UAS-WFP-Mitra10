        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form method="post" action="{{ route('auth.store') }}" class="space-y-4 md:space-y-6">
                        @csrf
                        <div>
                            <label for="email"
                                class="block mb-2 text-sm font-medium text-gray-900 @error('email') text-red-700 @enderror">Your
                                email</label>
                        ...
                        <div>
                            ...
                            @error('password') text-red-700 @enderror">Password</label>
                        ...
                        <p class="text-sm font-light text-gray-500">
                            ...
                            <a href="{{ route('register.create') }}" class="font-medium text-primary-600 hover:underline">
                                Sign up
                            </a>
                        </p>
                    </form>
