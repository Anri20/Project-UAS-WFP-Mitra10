...
@section('content')
    <select name="categoryType" id="categoryType">
        ...
        <option value="mc">Main Category</option>
        <option value="sc">Sub Category</option>
        <option value="cc">Child Category</option>
    </select>
    <br><br>
    ...
    <div class="modal fade" id="Edit" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body flex">
                    <label for="categoryNameUpdate">Nama Category</label>
                    <input id="categoryNameUpdate" type="text" value="">
                </div>
                <div class="modal-footer">
                    {{-- button ok --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('a').click(function() {
                ...
                categoryName = $(this).parent('td').parent('tr').children('td.nama').text()
            ...
            $('.confirmation').click(function() {
                if (checkType == "edit") {
                    newCategoryName = $("#categoryNameUpdate").val()
