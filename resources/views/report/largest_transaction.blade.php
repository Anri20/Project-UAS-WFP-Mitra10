...
<body class="p-5 bg-white dark:bg-gray-900 antialiased ">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex items-center justify-between gap-4 p-4 bg-white dark:bg-gray-900">
            <div>
            ...
            <div>
                ...
                <div id="dropdownAction"
                    class="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 hidden"
                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(65px, 66px);"
                    ...
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full"
                                src="https://i.pravatar.cc/150?u={{ $customer->email }}" alt="Jese image">
                            <div class="pl-3">
                        ...
                        <td class="px-6 py-4 text-right">
                            Rp{{ number_format($customer->total, 2, ',', '.') }}
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <a href="#"
                                class="font-medium text-green-600 dark:text-green-500 hover:underline">Chat
                                WhatsApp</a>
                        </td>
                    </tr>
                @endforeach
